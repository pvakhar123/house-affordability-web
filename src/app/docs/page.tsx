...
const sections: Section[] = [
  ...
  { id: "smart-fill", title: "Smart Fill (Document Upload)", icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 12l-3-3m0 0l-3 3m3-3v6m-1.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" },
  ...
  { id: "saved-reports", title: "Saved Reports & Sharing", icon: "M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0z" },
  { id: "knowledge-base", title: "Mortgage Knowledge Base", icon: "M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="/" className="flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800 font-medium">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex gap-8">
        ...
        <main className="flex-1 min-w-0 space-y-12">
          ...
          {/* ── Results Dashboard ── */}
          <section id="results">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Results Dashboard</h2>
            <p className="text-sm text-gray-600 mb-4">After running an analysis, results stream in progressively. The dashboard contains the following sections:</p>
            <div className="space-y-3">
              {[
          ...
          <section id="ai-agents">
            ...
            <p className="text-sm text-gray-600 mb-4">Your report is generated by 4 specialized AI agents that run in sequence, each focused on a specific domain:</p>
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { name: "Market Data Agent", desc: "Fetches live mortgage rates from the Federal Reserve (FRED), national home prices, Case-Shiller index, and inflation data from the Bureau of Labor Statistics. Also retrieves regional housing data for your target location.", color: "blue" },
                { name: "Affordability Agent", desc: "Calculates your maximum home price, monthly payment breakdown (PITI + PMI), debt-to-income ratios, and amortization schedule. Considers loan type, term, and down payment.", color: "green" },
                { name: "Risk Assessment Agent", desc: "Evaluates financial risk flags (DTI concerns, credit score issues, emergency fund gaps). Runs stress tests simulating rate increases and income drops. Rates overall risk level.", color: "amber" },
                { name: "Recommendations Agent", desc: "Determines loan program eligibility (Conventional, FHA, VA, USDA). Generates savings strategies, closing cost estimates, rent vs. buy analysis, and personalized advice based on your profile.", color: "purple" },
              ].map((agent) => (
                <div key={agent.name} className={`bg-white rounded-xl border border-gray-200 p-5`}>
                  <div className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium mb-2 bg-${agent.color}-50 text-${agent.color}-700`}>
          ...
          <section id="chat">
            ...
            <Card>
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-semibold text-gray-900 mb-1">What you can ask</p>
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 mb-1">Features</p>
                  <ul className="list-disc list-inside text-sm text-gray-500 space-y-1">
              ...
              <Card title="Report Actions">
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <p className="text-gray-500 text-xs mt-0.5">Generate a full-page PDF of your entire report including charts and data tables.</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="font-semibold text-gray-900">Save Report</p>
                    <p className="text-gray-500 text-xs mt-0.5">Save to your account (requires Google sign-in). Access anytime from the Saved Reports page.</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="font-semibold text-gray-900">Copy Share Link</p>
                    <p className="text-gray-500 text-xs mt-0.5">Generate a shareable URL with your report data compressed into the link. No sign-in required.</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="font-semibold text-gray-900">Email Report</p>
                    <p className="text-gray-500 text-xs mt-0.5">Send the report to any email address. Great for sharing with a partner, realtor, or financial advisor.</p>
                  </div>
                </div>
              </Card>
          ...
          <div className="border-t border-gray-200 pt-8 pb-4 text-center">
            <p className="text-xs text-gray-400">AI Home Research &middot; This is not financial advice. Use at your own risk.</p>
          </div>
        </main>
      </div>
    </div>
