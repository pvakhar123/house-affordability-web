      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6 space-y-5">
        ...
        <div className="space-y-3">
          {requiresAuth ? (
            ...
            <a
              href="/pricing"
              className="w-full flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-colors"
            >
              View Pro Plans
            </a>
          )}
